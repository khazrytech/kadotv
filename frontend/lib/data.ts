...
export const heroData = [
  {
    ...
    tag: 'Live Sport',
    description: 'Watch the greatest club football on earth — live in stunning HD with multi-angle replays.',
  ...
  },
  {
    ...
    title: 'Breaking Bad',
    tag: 'Series',
    description: 'The complete critically acclaimed series — all 5 seasons, binge-ready.',
    image: 'https://images.unsplash.com/photo-1605106702734-205df224ecce?w=1200&q=80',
  },
  {
    id: 'nba-finals',
    title: 'NBA Finals 2025',
    tag: 'Live Sport',
    description: 'Every game, every dunk — live coverage of the NBA Finals with expert commentary.',
