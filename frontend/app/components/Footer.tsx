...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    series: [
      { label: 'Crime', href: '/series' },
      { label: 'Fantasy', href: '/series' },
      { label: 'Thriller', href: '/series' },
      { label: 'Reality', href: '/series' },
    ],
    sports: [
      { label: 'Football', href: '/sports' },
      { label: 'Basketball', href: '/sports' },
      { label: 'Tennis', href: '/sports' },
      { label: 'Formula 1', href: '/sports' },
    ],
    company: [
      { label: 'About', href: '#' },
      { label: 'Careers', href: '#' },
  ...
  return (
    <footer className="bg-surface-2 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">KadoTV</span>
            </Link>
            <p className="mt-4 max-w-xs text-sm text-slate-400 leading-relaxed">
              The future of streaming. Movies, series, and live sports — all in one place.
            </p>
          ...
          {/* Movies */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Movies</h3>
          ...
          {/* Series */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Series</h3>
            <ul className="mt-4 space-y-2">
          ...
          {/* Sports */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider">Sports</h3>
            <ul className="mt-4 space-y-2">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/10 pt-8 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-sm text-slate-500">
            © {currentYear} KadoTV. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
